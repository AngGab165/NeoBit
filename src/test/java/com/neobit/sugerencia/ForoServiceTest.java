...
import com.neobit.sugerencia.negocio.NotificacionService;
...
class ForoServiceTest {
    ...
    void testAgregarRespuesta() {
        ...
        RespuestaForo respuesta = new RespuestaForo("Administrador Admin", "Contenido de prueba", LocalDate.now(),
                tema);
